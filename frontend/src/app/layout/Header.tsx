                ...
                className={({ isActive }) =>
                  [
                    ...
                    isActive
                      ...
                      : "bg-white dark:bg-gray-950 text-black dark:text-white shadow-brutal-sm hover:shadow-brutal-hover hover:translate-x-1 hover:translate-y-1 active:shadow-none active:translate-x-1.5 active:translate-y-1.5",
                  ].join(" ")
                }
              >
                {label}
